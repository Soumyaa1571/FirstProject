      ...
      <div className="signUpForm">
        ...
        <div className="form">
          <div className="inputSignUp">
            ...
            {/* <input type="email" id="formName" placeholder="Full Name" /> */}
            <input
              type="email"
              id="formName"
              value={userData.name}
          ...
          <div className="inputSignUp">
            ...
            {/* <input type="text" id="formImage" placeholder="Web Development/Machine learning/Embeded System" /> */}
            <input
              type="text"
              id="formDomain"
          ...
          <div className="inputSignUp">
            ...
            {/* <input type="text" id="formImage" placeholder="KRS Members/Students" /> */}
            <input
              type="text"
              id="formRole"
              value={userData.role}
          ...
          <div className="inputSignUp">
            ...
            {/* <input type="number" id="formPhone" placeholder="Eg: 1234567890" /> */}
            <input
              type="number"
              id="formPhone"
